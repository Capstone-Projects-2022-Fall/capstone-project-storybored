...
import { ApisApi, V1APIResource, V1APIResourceList, V1DeleteOptions, V1Status } from '@kubernetes/client-node/dist/api';
...
declare type KubernetesObjectResponseBody = KubernetesObject | KubernetesListObject<KubernetesObject> | V1Status | V1APIResourceList;
/** Kubernetes API verbs. */
declare type KubernetesApiAction = 'create' | 'delete' | 'patch' | 'read' | 'list' | 'replace';
declare type KubernetesObjectHeader<T extends KubernetesObject | KubernetesObject> = Pick<T, 'apiVersion' | 'kind'> & {
    metadata: {
        name: string;
        namespace: string;
    };
