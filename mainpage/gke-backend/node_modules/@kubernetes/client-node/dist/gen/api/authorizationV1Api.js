...
class AuthorizationV1Api {
     ...
     */
    async createNamespacedLocalSubjectAccessReview(namespace, body, dryRun, fieldManager, fieldValidation, pretty, options = { headers: {} }) {
     ...
     * @param pretty If \&#39;true\&#39;, then the output is pretty printed.
     */
    async createSelfSubjectAccessReview(body, dryRun, fieldManager, fieldValidation, pretty, options = { headers: {} }) {
     ...
     * @param pretty If \&#39;true\&#39;, then the output is pretty printed.
     */
    async createSelfSubjectRulesReview(body, dryRun, fieldManager, fieldValidation, pretty, options = { headers: {} }) {
     ...
     * @param pretty If \&#39;true\&#39;, then the output is pretty printed.
     */
    async createSubjectAccessReview(body, dryRun, fieldManager, fieldValidation, pretty, options = { headers: {} }) {
